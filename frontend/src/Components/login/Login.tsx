...
const validationSchema = Yup.object({
  ...
  password: Yup.string().min(4, "Password must be atleast 8 characters long").required("Password is required"),
});
    ...
    <div>
      ...
      <div className="mt-30 max-w-md mx-auto h-auto bg-white p-6 rounded-xl shadow-lg  border border-gray-200">
        <form onSubmit={formik.handleSubmit} className=" ">
          <div>
            <div>
              <h1 className="font-semibold text-black-800 text-center text-2xl"> Login </h1>
              <input
                type="email"
