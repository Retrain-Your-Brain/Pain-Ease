...
PostRouter.post('/create',upload.single("image"),isAuthenticated,PostControl.add)
PostRouter.get('/get-posts',isAuthenticated,PostControl.all)
PostRouter.get('/my-post',isAuthenticated,PostControl.myPost)
PostRouter.post('/posts/:postId/like',isAuthenticated,PostControl.like)
PostRouter.post('add/:postId',upload.single("image"), isAuthenticated,ReplyControl.add)
